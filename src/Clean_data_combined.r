...
library(lubridate)
library(readr)
df1 <- read.csv("/Users/saibrahmanaidukaturi/Desktop/US_Accidents_Dec21_updated.csv", stringsAsFactors = FALSE)
...
glimpse(df1)
write.csv(df1, file="/Users/saibrahmanaidukaturi/Desktop/final/5530_Project-main/data_clean/Accidents_Sai.csv")
